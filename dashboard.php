    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg fixed-top" id="navbar1">
                ...
                <a class="navbar-brand text-white" href="index.html" style ="font-family:  Montserrat, sans-serif; letter-spacing: 4px; font-weight: 500; height: 20px;">SOLAR SURVEIL</a>
                    </ul>
                </div>
            </nav>
        </div>
